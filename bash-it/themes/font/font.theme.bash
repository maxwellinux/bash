...
THEME_CLOCK_COLOR=${THEME_CLOCK_COLOR:-"$bold_yellow"}
THEME_CLOCK_FORMAT=${THEME_CLOCK_FORMAT:-"%I:%M:%S"}

THEME_SHOW_USER_HOST=true
USER_HOST_THEME_PROMPT_PREFIX="${bold_green}"
...
function prompt_command() {
    ...
    PS1="$(clock_prompt)${virtualenv}$(user_host_prompt)${bold_yellow}\W $(scm_prompt_char_info)${ret_status}→ ${bold_white}"
}
